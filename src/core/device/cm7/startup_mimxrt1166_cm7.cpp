...
__attribute__((used,
    ...
    GPIO6_Combined_0_15_IRQHandler,  // 77 : Combined interrupt indication for
                                     // GPIO6 signal 0 throughout 15
    GPIO6_Combined_16_31_IRQHandler, // 78 : Combined interrupt indication for
                                     // GPIO6 signal 16 throughout 31
    ...
    SNVS_PULSE_EVENT_IRQHandler, // 84 : ON-OFF button press shorter than 5 secs
                                 // (pulse event)
    ...
    GPIO13_Combined_0_31_IRQHandler,  // 109: Combined interrupt indication for
                                      // GPIO13 signal 0 throughout 31
    ...
    GPIO1_Combined_0_15_IRQHandler,   // 116: Combined interrupt indication for
                                      // GPIO1 signal 0 throughout 15
    GPIO1_Combined_16_31_IRQHandler,  // 117: Combined interrupt indication for
                                      // GPIO1 signal 16 throughout 31
    GPIO2_Combined_0_15_IRQHandler,   // 118: Combined interrupt indication for
                                      // GPIO2 signal 0 throughout 15
    GPIO2_Combined_16_31_IRQHandler,  // 119: Combined interrupt indication for
                                      // GPIO2 signal 16 throughout 31
    GPIO3_Combined_0_15_IRQHandler,   // 120: Combined interrupt indication for
                                      // GPIO3 signal 0 throughout 15
    GPIO3_Combined_16_31_IRQHandler,  // 121: Combined interrupt indication for
                                      // GPIO3 signal 16 throughout 31
    GPIO4_Combined_0_15_IRQHandler,   // 122: Combined interrupt indication for
                                      // GPIO4 signal 0 throughout 15
    GPIO4_Combined_16_31_IRQHandler,  // 123: Combined interrupt indication for
                                      // GPIO4 signal 16 throughout 31
    GPIO5_Combined_0_15_IRQHandler,   // 124: Combined interrupt indication for
                                      // GPIO5 signal 0 throughout 15
    GPIO5_Combined_16_31_IRQHandler,  // 125: Combined interrupt indication for
                                      // GPIO5 signal 16 throughout 31
...
// memory.
//*****************************************************************************
__attribute__((section(".after_vectors.init_data"))) void
...
__attribute__((section(".after_vectors.init_bss"))) void
...
__attribute__((naked, section(".after_vectors.reset"))) void ResetISR(void) {
    ...
    // FlexRAM configuration for DTCM 448 KB and ITCM 64KB by modifying
    // IOMUXC_GPR 17 and 18
    __asm volatile("DSB\n"
                   "ISB\n"

                   "LDR R0,=0x400E4044\n" // Load IOMUXC_GPR17 register
                                          // address to R0
                   "LDR R1,=0x0000AAAA\n" // Move FlexRAM configuration for
                                          // GPR17 value to R1. 8 banks for DTCM
                   "STR R1,[R0]\n"

                   "LDR R0,=0x400E4048\n" // Load IOMUXC_GPR18 register
                                          // address to R0
                   "LDR R1,=0x0000FAAA\n" // Move FlexRAM configuration for
                                          // GPR18 value to R1. 6 banks for DTCM
                                          // and 2 banks for ITCM
                   "STR R1,[R0]\n"

                   "DSB\n"
                   "ISB\n");

    // Set FlexRAM configuration to be based on the IOMUXC registers
    __asm volatile(
        "LDR R0,=0x400E4040\n" // Load IOMUXC_GPR16 register address to
                               // R0

        "LDR R1,[R0]\n" // Load IOMUXC_GPR16 register value to R1

        "ORR R1, R1, #4\n" // Set corresponding FLEXRAM_BANK_CFG_SEL bit so that
                           // the FlexRAM uses the configuration from IOMUXC
                           // GPR17 and GPR18

        "STR R1,[R0]\n" // Store the value to IOMUXC_GPR16
...
// handler is included.
//*****************************************************************************
WEAK void DMA0_DMA16_IRQHandler(void) { DMA0_DMA16_DriverIRQHandler(); }

WEAK void DMA1_DMA17_IRQHandler(void) { DMA1_DMA17_DriverIRQHandler(); }

WEAK void DMA2_DMA18_IRQHandler(void) { DMA2_DMA18_DriverIRQHandler(); }

WEAK void DMA3_DMA19_IRQHandler(void) { DMA3_DMA19_DriverIRQHandler(); }

WEAK void DMA4_DMA20_IRQHandler(void) { DMA4_DMA20_DriverIRQHandler(); }

WEAK void DMA5_DMA21_IRQHandler(void) { DMA5_DMA21_DriverIRQHandler(); }

WEAK void DMA6_DMA22_IRQHandler(void) { DMA6_DMA22_DriverIRQHandler(); }

WEAK void DMA7_DMA23_IRQHandler(void) { DMA7_DMA23_DriverIRQHandler(); }

WEAK void DMA8_DMA24_IRQHandler(void) { DMA8_DMA24_DriverIRQHandler(); }

WEAK void DMA9_DMA25_IRQHandler(void) { DMA9_DMA25_DriverIRQHandler(); }

WEAK void DMA10_DMA26_IRQHandler(void) { DMA10_DMA26_DriverIRQHandler(); }

WEAK void DMA11_DMA27_IRQHandler(void) { DMA11_DMA27_DriverIRQHandler(); }

WEAK void DMA12_DMA28_IRQHandler(void) { DMA12_DMA28_DriverIRQHandler(); }

WEAK void DMA13_DMA29_IRQHandler(void) { DMA13_DMA29_DriverIRQHandler(); }

WEAK void DMA14_DMA30_IRQHandler(void) { DMA14_DMA30_DriverIRQHandler(); }

WEAK void DMA15_DMA31_IRQHandler(void) { DMA15_DMA31_DriverIRQHandler(); }

WEAK void DMA_ERROR_IRQHandler(void) { DMA_ERROR_DriverIRQHandler(); }
...
WEAK void CORE_IRQHandler(void) { CORE_DriverIRQHandler(); }

WEAK void LPUART1_IRQHandler(void) { LPUART1_DriverIRQHandler(); }

WEAK void LPUART2_IRQHandler(void) { LPUART2_DriverIRQHandler(); }

WEAK void LPUART3_IRQHandler(void) { LPUART3_DriverIRQHandler(); }

WEAK void LPUART4_IRQHandler(void) { LPUART4_DriverIRQHandler(); }

WEAK void LPUART5_IRQHandler(void) { LPUART5_DriverIRQHandler(); }

WEAK void LPUART6_IRQHandler(void) { LPUART6_DriverIRQHandler(); }

WEAK void LPUART7_IRQHandler(void) { LPUART7_DriverIRQHandler(); }

WEAK void LPUART8_IRQHandler(void) { LPUART8_DriverIRQHandler(); }

WEAK void LPUART9_IRQHandler(void) { LPUART9_DriverIRQHandler(); }

WEAK void LPUART10_IRQHandler(void) { LPUART10_DriverIRQHandler(); }

WEAK void LPUART11_IRQHandler(void) { LPUART11_DriverIRQHandler(); }

WEAK void LPUART12_IRQHandler(void) { LPUART12_DriverIRQHandler(); }

WEAK void LPI2C1_IRQHandler(void) { LPI2C1_DriverIRQHandler(); }

WEAK void LPI2C2_IRQHandler(void) { LPI2C2_DriverIRQHandler(); }

WEAK void LPI2C3_IRQHandler(void) { LPI2C3_DriverIRQHandler(); }

WEAK void LPI2C4_IRQHandler(void) { LPI2C4_DriverIRQHandler(); }

WEAK void LPI2C5_IRQHandler(void) { LPI2C5_DriverIRQHandler(); }

WEAK void LPI2C6_IRQHandler(void) { LPI2C6_DriverIRQHandler(); }

WEAK void LPSPI1_IRQHandler(void) { LPSPI1_DriverIRQHandler(); }

WEAK void LPSPI2_IRQHandler(void) { LPSPI2_DriverIRQHandler(); }

WEAK void LPSPI3_IRQHandler(void) { LPSPI3_DriverIRQHandler(); }

WEAK void LPSPI4_IRQHandler(void) { LPSPI4_DriverIRQHandler(); }

WEAK void LPSPI5_IRQHandler(void) { LPSPI5_DriverIRQHandler(); }

WEAK void LPSPI6_IRQHandler(void) { LPSPI6_DriverIRQHandler(); }

WEAK void CAN1_IRQHandler(void) { CAN1_DriverIRQHandler(); }

WEAK void CAN1_ERROR_IRQHandler(void) { CAN1_ERROR_DriverIRQHandler(); }

WEAK void CAN2_IRQHandler(void) { CAN2_DriverIRQHandler(); }

WEAK void CAN2_ERROR_IRQHandler(void) { CAN2_ERROR_DriverIRQHandler(); }

WEAK void CAN3_IRQHandler(void) { CAN3_DriverIRQHandler(); }

WEAK void CAN3_ERROR_IRQHandler(void) { CAN3_ERROR_DriverIRQHandler(); }

WEAK void FLEXRAM_IRQHandler(void) { FLEXRAM_DriverIRQHandler(); }

WEAK void KPP_IRQHandler(void) { KPP_DriverIRQHandler(); }

WEAK void Reserved68_IRQHandler(void) { Reserved68_DriverIRQHandler(); }

WEAK void GPR_IRQ_IRQHandler(void) { GPR_IRQ_DriverIRQHandler(); }

WEAK void eLCDIF_IRQHandler(void) { eLCDIF_DriverIRQHandler(); }

WEAK void LCDIFv2_IRQHandler(void) { LCDIFv2_DriverIRQHandler(); }

WEAK void CSI_IRQHandler(void) { CSI_DriverIRQHandler(); }

WEAK void PXP_IRQHandler(void) { PXP_DriverIRQHandler(); }

WEAK void MIPI_CSI_IRQHandler(void) { MIPI_CSI_DriverIRQHandler(); }

WEAK void MIPI_DSI_IRQHandler(void) { MIPI_DSI_DriverIRQHandler(); }

WEAK void GPU2D_IRQHandler(void) { GPU2D_DriverIRQHandler(); }
...
WEAK void DAC_IRQHandler(void) { DAC_DriverIRQHandler(); }

WEAK void KEY_MANAGER_IRQHandler(void) { KEY_MANAGER_DriverIRQHandler(); }

WEAK void WDOG2_IRQHandler(void) { WDOG2_DriverIRQHandler(); }

WEAK void SNVS_HP_NON_TZ_IRQHandler(void) { SNVS_HP_NON_TZ_DriverIRQHandler(); }

WEAK void SNVS_HP_TZ_IRQHandler(void) { SNVS_HP_TZ_DriverIRQHandler(); }

WEAK void SNVS_PULSE_EVENT_IRQHandler(void) {
    SNVS_PULSE_EVENT_DriverIRQHandler();
}

WEAK void CAAM_IRQ0_IRQHandler(void) { CAAM_IRQ0_DriverIRQHandler(); }

WEAK void CAAM_IRQ1_IRQHandler(void) { CAAM_IRQ1_DriverIRQHandler(); }

WEAK void CAAM_IRQ2_IRQHandler(void) { CAAM_IRQ2_DriverIRQHandler(); }

WEAK void CAAM_IRQ3_IRQHandler(void) { CAAM_IRQ3_DriverIRQHandler(); }

WEAK void CAAM_RECORVE_ERRPR_IRQHandler(void) {
    CAAM_RECORVE_ERRPR_DriverIRQHandler();
}

WEAK void CAAM_RTIC_IRQHandler(void) { CAAM_RTIC_DriverIRQHandler(); }

WEAK void CDOG_IRQHandler(void) { CDOG_DriverIRQHandler(); }

WEAK void SAI1_IRQHandler(void) { SAI1_DriverIRQHandler(); }

WEAK void SAI2_IRQHandler(void) { SAI2_DriverIRQHandler(); }

WEAK void SAI3_RX_IRQHandler(void) { SAI3_RX_DriverIRQHandler(); }

WEAK void SAI3_TX_IRQHandler(void) { SAI3_TX_DriverIRQHandler(); }

WEAK void SAI4_RX_IRQHandler(void) { SAI4_RX_DriverIRQHandler(); }

WEAK void SAI4_TX_IRQHandler(void) { SAI4_TX_DriverIRQHandler(); }

WEAK void SPDIF_IRQHandler(void) { SPDIF_DriverIRQHandler(); }

WEAK void TMPSNS_INT_IRQHandler(void) { TMPSNS_INT_DriverIRQHandler(); }

WEAK void TMPSNS_LOW_HIGH_IRQHandler(void) {
    TMPSNS_LOW_HIGH_DriverIRQHandler();
}

WEAK void TMPSNS_PANIC_IRQHandler(void) { TMPSNS_PANIC_DriverIRQHandler(); }
...
WEAK void ADC2_IRQHandler(void) { ADC2_DriverIRQHandler(); }

WEAK void USBPHY1_IRQHandler(void) { USBPHY1_DriverIRQHandler(); }

WEAK void USBPHY2_IRQHandler(void) { USBPHY2_DriverIRQHandler(); }

WEAK void RDC_IRQHandler(void) { RDC_DriverIRQHandler(); }

WEAK void GPIO13_Combined_0_31_IRQHandler(void) {
    GPIO13_Combined_0_31_DriverIRQHandler();
}

WEAK void Reserved110_IRQHandler(void) { Reserved110_DriverIRQHandler(); }

WEAK void DCIC1_IRQHandler(void) { DCIC1_DriverIRQHandler(); }

WEAK void DCIC2_IRQHandler(void) { DCIC2_DriverIRQHandler(); }

WEAK void ASRC_IRQHandler(void) { ASRC_DriverIRQHandler(); }

WEAK void FLEXRAM_ECC_IRQHandler(void) { FLEXRAM_ECC_DriverIRQHandler(); }

WEAK void CM7_GPIO2_3_IRQHandler(void) { CM7_GPIO2_3_DriverIRQHandler(); }
...
WEAK void FLEXIO1_IRQHandler(void) { FLEXIO1_DriverIRQHandler(); }

WEAK void FLEXIO2_IRQHandler(void) { FLEXIO2_DriverIRQHandler(); }

WEAK void WDOG1_IRQHandler(void) { WDOG1_DriverIRQHandler(); }

WEAK void RTWDOG3_IRQHandler(void) { RTWDOG3_DriverIRQHandler(); }
...
WEAK void GPC_IRQHandler(void) { GPC_DriverIRQHandler(); }

WEAK void MUA_IRQHandler(void) { MUA_DriverIRQHandler(); }

WEAK void GPT1_IRQHandler(void) { GPT1_DriverIRQHandler(); }

WEAK void GPT2_IRQHandler(void) { GPT2_DriverIRQHandler(); }

WEAK void GPT3_IRQHandler(void) { GPT3_DriverIRQHandler(); }

WEAK void GPT4_IRQHandler(void) { GPT4_DriverIRQHandler(); }

WEAK void GPT5_IRQHandler(void) { GPT5_DriverIRQHandler(); }

WEAK void GPT6_IRQHandler(void) { GPT6_DriverIRQHandler(); }

WEAK void PWM1_0_IRQHandler(void) { PWM1_0_DriverIRQHandler(); }

WEAK void PWM1_1_IRQHandler(void) { PWM1_1_DriverIRQHandler(); }

WEAK void PWM1_2_IRQHandler(void) { PWM1_2_DriverIRQHandler(); }

WEAK void PWM1_3_IRQHandler(void) { PWM1_3_DriverIRQHandler(); }

WEAK void PWM1_FAULT_IRQHandler(void) { PWM1_FAULT_DriverIRQHandler(); }

WEAK void FLEXSPI1_IRQHandler(void) { FLEXSPI1_DriverIRQHandler(); }

WEAK void FLEXSPI2_IRQHandler(void) { FLEXSPI2_DriverIRQHandler(); }

WEAK void SEMC_IRQHandler(void) { SEMC_DriverIRQHandler(); }

WEAK void USDHC1_IRQHandler(void) { USDHC1_DriverIRQHandler(); }

WEAK void USDHC2_IRQHandler(void) { USDHC2_DriverIRQHandler(); }

WEAK void USB_OTG2_IRQHandler(void) { USB_OTG2_DriverIRQHandler(); }

WEAK void USB_OTG1_IRQHandler(void) { USB_OTG1_DriverIRQHandler(); }

WEAK void ENET_IRQHandler(void) { ENET_DriverIRQHandler(); }
...
WEAK void ENET_1G_IRQHandler(void) { ENET_1G_DriverIRQHandler(); }

WEAK void ENET_1G_1588_Timer_IRQHandler(void) {
    ENET_1G_1588_Timer_DriverIRQHandler();
}

WEAK void XBAR1_IRQ_0_1_IRQHandler(void) { XBAR1_IRQ_0_1_DriverIRQHandler(); }

WEAK void XBAR1_IRQ_2_3_IRQHandler(void) { XBAR1_IRQ_2_3_DriverIRQHandler(); }

WEAK void ADC_ETC_IRQ0_IRQHandler(void) { ADC_ETC_IRQ0_DriverIRQHandler(); }

WEAK void ADC_ETC_IRQ1_IRQHandler(void) { ADC_ETC_IRQ1_DriverIRQHandler(); }

WEAK void ADC_ETC_IRQ2_IRQHandler(void) { ADC_ETC_IRQ2_DriverIRQHandler(); }

WEAK void ADC_ETC_IRQ3_IRQHandler(void) { ADC_ETC_IRQ3_DriverIRQHandler(); }

WEAK void ADC_ETC_ERROR_IRQ_IRQHandler(void) {
    ADC_ETC_ERROR_IRQ_DriverIRQHandler();
}

WEAK void Reserved166_IRQHandler(void) { Reserved166_DriverIRQHandler(); }

WEAK void Reserved167_IRQHandler(void) { Reserved167_DriverIRQHandler(); }

WEAK void Reserved168_IRQHandler(void) { Reserved168_DriverIRQHandler(); }

WEAK void Reserved169_IRQHandler(void) { Reserved169_DriverIRQHandler(); }

WEAK void Reserved170_IRQHandler(void) { Reserved170_DriverIRQHandler(); }

WEAK void PIT1_IRQHandler(void) { PIT1_DriverIRQHandler(); }

WEAK void PIT2_IRQHandler(void) { PIT2_DriverIRQHandler(); }

WEAK void ACMP1_IRQHandler(void) { ACMP1_DriverIRQHandler(); }

WEAK void ACMP2_IRQHandler(void) { ACMP2_DriverIRQHandler(); }

WEAK void ACMP3_IRQHandler(void) { ACMP3_DriverIRQHandler(); }

WEAK void ACMP4_IRQHandler(void) { ACMP4_DriverIRQHandler(); }

WEAK void Reserved177_IRQHandler(void) { Reserved177_DriverIRQHandler(); }

WEAK void Reserved178_IRQHandler(void) { Reserved178_DriverIRQHandler(); }

WEAK void Reserved179_IRQHandler(void) { Reserved179_DriverIRQHandler(); }

WEAK void Reserved180_IRQHandler(void) { Reserved180_DriverIRQHandler(); }

WEAK void ENC1_IRQHandler(void) { ENC1_DriverIRQHandler(); }

WEAK void ENC2_IRQHandler(void) { ENC2_DriverIRQHandler(); }

WEAK void ENC3_IRQHandler(void) { ENC3_DriverIRQHandler(); }

WEAK void ENC4_IRQHandler(void) { ENC4_DriverIRQHandler(); }

WEAK void Reserved185_IRQHandler(void) { Reserved185_DriverIRQHandler(); }

WEAK void Reserved186_IRQHandler(void) { Reserved186_DriverIRQHandler(); }

WEAK void TMR1_IRQHandler(void) { TMR1_DriverIRQHandler(); }

WEAK void TMR2_IRQHandler(void) { TMR2_DriverIRQHandler(); }

WEAK void TMR3_IRQHandler(void) { TMR3_DriverIRQHandler(); }

WEAK void TMR4_IRQHandler(void) { TMR4_DriverIRQHandler(); }

WEAK void SEMA4_CP0_IRQHandler(void) { SEMA4_CP0_DriverIRQHandler(); }

WEAK void SEMA4_CP1_IRQHandler(void) { SEMA4_CP1_DriverIRQHandler(); }

WEAK void PWM2_0_IRQHandler(void) { PWM2_0_DriverIRQHandler(); }

WEAK void PWM2_1_IRQHandler(void) { PWM2_1_DriverIRQHandler(); }

WEAK void PWM2_2_IRQHandler(void) { PWM2_2_DriverIRQHandler(); }

WEAK void PWM2_3_IRQHandler(void) { PWM2_3_DriverIRQHandler(); }

WEAK void PWM2_FAULT_IRQHandler(void) { PWM2_FAULT_DriverIRQHandler(); }

WEAK void PWM3_0_IRQHandler(void) { PWM3_0_DriverIRQHandler(); }

WEAK void PWM3_1_IRQHandler(void) { PWM3_1_DriverIRQHandler(); }

WEAK void PWM3_2_IRQHandler(void) { PWM3_2_DriverIRQHandler(); }

WEAK void PWM3_3_IRQHandler(void) { PWM3_3_DriverIRQHandler(); }

WEAK void PWM3_FAULT_IRQHandler(void) { PWM3_FAULT_DriverIRQHandler(); }

WEAK void PWM4_0_IRQHandler(void) { PWM4_0_DriverIRQHandler(); }

WEAK void PWM4_1_IRQHandler(void) { PWM4_1_DriverIRQHandler(); }

WEAK void PWM4_2_IRQHandler(void) { PWM4_2_DriverIRQHandler(); }

WEAK void PWM4_3_IRQHandler(void) { PWM4_3_DriverIRQHandler(); }

WEAK void PWM4_FAULT_IRQHandler(void) { PWM4_FAULT_DriverIRQHandler(); }

WEAK void Reserved208_IRQHandler(void) { Reserved208_DriverIRQHandler(); }

WEAK void Reserved209_IRQHandler(void) { Reserved209_DriverIRQHandler(); }

WEAK void Reserved210_IRQHandler(void) { Reserved210_DriverIRQHandler(); }

WEAK void Reserved211_IRQHandler(void) { Reserved211_DriverIRQHandler(); }

WEAK void Reserved212_IRQHandler(void) { Reserved212_DriverIRQHandler(); }

WEAK void Reserved213_IRQHandler(void) { Reserved213_DriverIRQHandler(); }

WEAK void Reserved214_IRQHandler(void) { Reserved214_DriverIRQHandler(); }

WEAK void Reserved215_IRQHandler(void) { Reserved215_DriverIRQHandler(); }
...
WEAK void PDM_EVENT_IRQHandler(void) { PDM_EVENT_DriverIRQHandler(); }

WEAK void PDM_ERROR_IRQHandler(void) { PDM_ERROR_DriverIRQHandler(); }

WEAK void EMVSIM1_IRQHandler(void) { EMVSIM1_DriverIRQHandler(); }

WEAK void EMVSIM2_IRQHandler(void) { EMVSIM2_DriverIRQHandler(); }

WEAK void MECC1_INT_IRQHandler(void) { MECC1_INT_DriverIRQHandler(); }

WEAK void MECC1_FATAL_INT_IRQHandler(void) {
    MECC1_FATAL_INT_DriverIRQHandler();
}

WEAK void MECC2_INT_IRQHandler(void) { MECC2_INT_DriverIRQHandler(); }
...
WEAK void XECC_SEMC_INT_IRQHandler(void) { XECC_SEMC_INT_DriverIRQHandler(); }
